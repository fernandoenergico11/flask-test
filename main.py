...
def generar_numeros():
    ...
    try:
        with pymysql.connect(host='https://databases-auth.000webhost.com/index.php?route=/database/structure&db=id21685083_bolsagana', user='id21685083_root', passwd='Energia11@', db='id21685083_bolsagana') as miConexion:
